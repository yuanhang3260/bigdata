...
public class HbaseTableInputSplit extends LocatableInputSplit {
   ...
   *        the end row of the split
   */
  HbaseTableInputSplit(final int splitNumber, final String[] hostnames, final byte[] tableName, final byte[] startRow,
                       final byte[] endRow) {
